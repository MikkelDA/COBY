...
import copy
from CGSB.general_functions.__init__ import flatten
                    ...
                    if leaflet["split_bbox"]:
                        try:
                            ...
                            self.print_term(
                                ...
                                "Please report this to https://github.com/MikkelDA/CGSB with the entire CGSB command that you have used.",
                                warn=True
                            )
