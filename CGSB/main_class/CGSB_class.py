...
### Placeholders in case none are defined in "CGSB.molecule_definitions.__init__"
lipid_scaffolds = {}
lipid_defs      = {}
solvent_defs    = {}
ion_defs        = {}
...
from CGSB.molecule_definitions.__init__ import *
from CGSB.structure_classes.__init__ import *
from CGSB.general_functions.__init__ import *


from CGSB.main_class.structure_file_handlers.__init__ import *
from CGSB.main_class.topology_handlers.__init__ import *
from CGSB.main_class.general_tools.__init__ import *
from CGSB.main_class.definition_preprocessors.__init__ import *
from CGSB.main_class.command_preprocessors.__init__ import *
from CGSB.main_class.special_preprocessors.__init__ import *

from CGSB.main_class.protein_inserter.__init__ import *
from CGSB.main_class.polygon_makers.__init__ import *
from CGSB.main_class.lipid_calculator.__init__ import *
from CGSB.main_class.planar_grid_maker_and_optimizer.__init__ import *
from CGSB.main_class.lipid_inserter.__init__ import *
from CGSB.main_class.solvater.__init__ import *
...
#         self.output_system_file_name     = "output"
        ...
        self.LOG_FILE.append("The following CGSB arguments will be processed:" + "\n")
        self.LOG_FILE.append("CGSB(" + "\n")
    ...
    def commands_handler(self, kwargs):
        ...
        for key, cmd in kwargs.items():
            ...
            ### Run the program
                ...
                assert False, "Invalid argument given to CGSB: " + str((key, cmd))
        ...
        if self.pdb_unitcell or self.gro_unitcell:
            assert not (self.pdb_unitcell and self.gro_unitcell), "Only one of the 'pdb_unitcell' and 'gro_unitcell' arguments may be used in a single call to CGSB"
    ...
    def run(self, kwargs):
        ...
        CGSB_run_time = round(CGSB_run_toc - self.CGSB_run_tic, 4)
