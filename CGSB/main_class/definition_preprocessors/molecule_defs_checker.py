from CGSB.main_class.definition_preprocessors.molecule_beads_checker import molecule_beads_checker
from CGSB.main_class.general_tools.rotation_matrix_from_vectors import rotation_matrix_from_vectors
import numpy as np
import math
