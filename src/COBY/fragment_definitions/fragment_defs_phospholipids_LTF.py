...
fragment_defs[moltype]["parts"][molpart].update({
    ...
    "PL": { # Plasmalogen
        "beads": [
            {"name": "GL1", "charge": 0, "x": 0,     "y": 0, "z": 0, "resname": False, "resnr": 0},
            {"name": "PL2", "charge": 0, "x": 0.125, "y": 0, "z": 0, "resname": False, "resnr": 0},
        ],
        "join_from": {
            "head":  (0,     0, 0), # GL1 bead
            "tail1": (0,     0, 0), # GL1 bead
            "tail2": (0.125, 0, 0), # PL2 bead
        },
    },

    "ET": { # Ether lipid
        "beads": [
            {"name": "ET1", "charge": 0, "x": 0,     "y": 0, "z": 0, "resname": False, "resnr": 0},
            {"name": "ET2", "charge": 0, "x": 0.125, "y": 0, "z": 0, "resname": False, "resnr": 0},
        ],
        "join_from": {
            "head":  (0,     0, 0), # ET1 bead
            "tail1": (0,     0, 0), # ET1 bead
            "tail2": (0.125, 0, 0), # ET2 bead
        },
    },
})
