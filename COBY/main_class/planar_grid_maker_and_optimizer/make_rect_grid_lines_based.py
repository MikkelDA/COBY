...
class make_rect_grid_lines_based:
    def make_rect_grid_lines_based(self, leaflet, subleaflet, occupation_modifier):
        ...
        bbox_polygon_BufferedForLineStrings = shapely.buffer(bbox_polygon, -mean_lipid_radius*0.9) # *0.9 to prevent the outermost ylines from being removed
        dict_for_plotting = {
        ...
        while enough_points == False:
            ...
            if ngridpoints < len(lipids):
                ...
                if xlines > xlines_ideal*1.25 or ylines > ylines_ideal*1.25:
                    ...
                    bbox_polygon_BufferedForLineStrings = shapely.buffer(bbox_polygon, -mean_lipid_radius*0.9)
