...
For personal implementation of new structures (lipids/solvents/solutes), one can consult The [Technical tutorial](https://github.com/MikkelDA/COBY/blob/master/Tutorial/4_Technical_tutorial.ipynb) notebook.
